                ...
                <div class="detail-container">
                    <header class="headers">
                        ...
                        <button class="btn close">
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="xmark"
                                class="svg-inline--fa fa-xmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" onClick={onClose}>
                    ...
                    <div class="content">
                        ...
                        <div class="user-details">
                            ...
                            <p>
                                Address:
                                <strong> {user.county}, {user.city}, {user.street} {user.streetNumber} </strong>
                            </p>
